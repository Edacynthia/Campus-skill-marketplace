    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-6">
        <div class="max-w-6xl w-full bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="grid md:grid-cols-2">
                ...
                <!-- Desktop Left Side - Hero / Information -->
                ...
                <div class="p-6 md:p-10 lg:p-16 flex flex-col justify-center">
                    ...
                    <div class="hidden md:block mb-8">
                        ...
                        <p class="text-gray-600 mt-2">Sign in with your credentials.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Students & faculty: use your institutional email • Staff: use your registered email</p>
                        </div>
                    ...
                    <div class="mt-8 space-y-4 text-center">
                        ...
                        <div>
                            <a href="#" class="text-[#1e3a8a] hover:underline text-sm">Need help? Contact Registrar Support</a>
                        </div>

                        <div>
                            <a href="{{ route('register') }}" class="text-[#1e3a8a] hover:underline text-sm">Don't have an account? Sign up</a>
                        </div>
